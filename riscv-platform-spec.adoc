...
should be easily movable between different hardware.
...
All the requirements in this specification are MANDATORY unless specifically called out in the relevant 
